...
<head>
	...
	$(function(){
		...
		$(".edit_Btn").click(function(){
			...
			$("#bankType option[value="+json.bankName+"]").attr("selected","selected");
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<div class="row">
					<!-- 提交分页的表单 -->
					<form id="searchForm" class="form-inline" method="post" action="/platformBankInfo_list">
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
			       		<form id="editForm" class="form-horizontal" method="post" action="platformBankInfo_update" style="margin: -3px 118px">
