	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/rechargeOffline_list">
					...
					<div class="form-group">
					    <label>交易时间</label>
					    <input class="form-control" type="text" name="tradeBeginTime" id="beginTime" value="${(qo.tradeBeginTime?string('yyyy-MM-dd'))!''}" />到
					    <input class="form-control" type="text" name="tradeEndTime" id="endTime" value="${(qo.tradeEndTime?string('yyyy-MM-dd'))!''}" />
					</div>
					<div class="form-group">
					    <label>交易号</label>
