                ...
                <form id="userInfoForm" class="form-horizontal" action="/basicInfo_save" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <script type="text/javascript">
                                $("#educationBackground option[value=${(userinfo.educationBackground.id)!''}]").prop("selected", true)
                            </script>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <script type="text/javascript">
                                $("#incomeGrade option[value=${(userinfo.incomeGrade.id)!''}]").prop("selected", true)
                            </script>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <script type="text/javascript">
                                $("#marriage option[value=${(userinfo.marriage.id)!''}]").prop("selected", true)
                            </script>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <script type="text/javascript">
                                $("#kidCount option[value=${(userinfo.kidCount.id)!''}]").prop("selected", true)
                            </script>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <script type="text/javascript">
                                $("#houseCondition option[value=${(userinfo.houseCondition.id)!''}]").prop("selected", true)
                            </script>
                        </div>
                    </div>
