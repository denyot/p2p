...
<html>
	<head>
		...
		<title>蓝源Eloan-P2P平台 充值明细</title>
				...
				<div class="col-sm-9">
					<form action="/recharge_list" name="searchForm" id="searchForm" class="form-inline">
						...
						<div class="form-group">
							<label>时间范围</label>
							<input type="text" class="form-control beginDate" name="beginTime" value="${(qo.beginTime?string('yyyy-MM-dd'))!''}"/>
						</div>
						<div class="form-group">
							<label></label>
							<input type="text" class="form-control endDate" name="endTime" value="${(qo.endTime?string('yyyy-MM-dd'))!''}"/>
						</div>
						<div class="form-group">
						    <label>状态</label>
							...
							<tbody>
								<#list pageResult.result as data>
									<tr>
										...
										<td>${data.applyTime?string("yyyy-MM-dd")}</td>
								        <td>${data.amount} 元</td>
