		...
		<div class="container" style="margin-top: 10px;">
			...
			<div class="row">
				...
				<div class="col-sm-3">
					...
					<#if bidRequest.bidRequestState==1>
						<#if !self??>
							<br />
							<a class="btn btn-danger btn-block" style="font-size: 18px;" href="/login.jsp">
								登录投标
							</a>
						<#elseif self>
							<br />
						...
						<#elseif account?? && !self>
						<input id="usableAmount" autocomplete="off" value="${account.usableAmount?string('###.##')}" type="hidden"/>
						<input id="minBidAmount" autocomplete="off" value="${bidRequest.minBidAmount?string('###.##')}" type="hidden"/>
						<input id="maxBidAmount" autocomplete="off" value="${bidRequest.remainAmount?string('###.##')}" type="hidden"/>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
						...
						<tbody>
							<#if bidRequest.bidList?size &gt; 0>
								<#list bidRequest.bidList as bid>
									<tr>
